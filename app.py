...
from flask import Flask, jsonify, flash, request, redirect, url_for, render_template,send_file, jsonify 
...
def submit():
    ...
    if (file and allowed_file(file.filename)) and (file2 and allowed_file(file2.filename)):
        ...
        return render_template('main.html', filename=filename,filename2=filename2)
    else:
        return redirect(request.url) 
...
def compute(filename,filename2):
    ...
    end_time = h + ":" + m + ":" + s + " " + t
    print(end_time)
    # h =request.form['clicked1']
    # m =request.form['clicked2']
    # s =request.form['clicked3']
    # t =request.form['clicked4']
    # if len(h) == 1:
    #     h = "0" + str(h)
    # if len(m) == 1:
    ...
    # start_time = h + ":" + m + ":" + s + " " + t
    # print(start_time)
    # h =request.form['clicked5']
    # m = request.form['clicked6']
    # s = request.form['clicked7']
    # t = request.form['clicked8']
    # if len(h) == 1:
    #     h = "0" + str(h)
    # if len(m) == 1:
